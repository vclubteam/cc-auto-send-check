...
SESSION_STRING = "your_generated_string_session_here"  # Replace with your string session
...
app = Client("card_checker_bot", api_id=API_ID, api_hash=API_HASH, session_string=SESSION_STRING)
